...
$PAGE->set_url('/mod/vinapsechat/index.php', array('id' => $id));
...
$modulenameplural = get_string('modulenameplural', 'mod_vinapsechat');
echo $OUTPUT->heading($modulenameplural);

$vinapses = get_all_instances_in_course('vinapsechat', $course);

if (empty($vinapses)) {
    notice(get_string('noresources', 'mod_vinapsechat'), new moodle_url('/course/view.php', array('id' => $course->id)));
}
...
foreach ($vinapses as $vinapse) {
    if (!$vinapse->visible) {
        $link = html_writer::link(
            new moodle_url('/mod/vinapsechat/view.php', array('id' => $vinapse->coursemodule)),
    ...
    $intro = format_module_intro('vinapsechat', $vinapse, $vinapse->coursemodule);
